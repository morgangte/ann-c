...
$(TRAIN_EXEC): $(SRC_DIR)/train.o $(SRC_DIR)/mnist.o $(SRC_DIR)/neuralnetwork.o $(SRC_DIR)/layer.o $(SRC_DIR)/training.o
	$(CC) $^ -o $@ $(LIB)

$(TEST_EXEC): $(SRC_DIR)/test.o $(SRC_DIR)/mnist.o $(SRC_DIR)/neuralnetwork.o $(SRC_DIR)/layer.o $(SRC_DIR)/training.o
	$(CC) $^ -o $@ $(LIB)
